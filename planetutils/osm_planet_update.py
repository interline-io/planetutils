...
def main():
    ...
    parser.add_argument('--toolchain', help='OSM toolchain: osmium (default, no system binaries required) or osmosis (requires Java)', default='osmium')
    ...
    parser.add_argument('--workdir', help="Osmosis replication workingDirectory. Defaults to a .workdir alongside the planet file.", default=None)
    ...
    if args.toolchain == 'osmosis':
        p = PlanetUpdaterOsmosis(args.osmpath, osmosis_workdir=args.workdir)
